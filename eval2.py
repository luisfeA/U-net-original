...
if __name__ == "__main__":
    ...
    for i in range(1, 11):
        ...
        if i == 1:
            (train_x, train_y), (valid_x, valid_y), (test_x, test_y) = load_data(dataset_path)
            save_path = "experimentos/resultados/experimento1/caso2/"
            cvc_path = "experimentos/resultados/experimento1/caso2/score.csv"
            """ Load Model """
            with CustomObjectScope({'iou': iou, 'dice_coef': dice_coef}):
                model = tf.keras.models.load_model("/home/DIINF/labello/U-net-original/files-con-una-perdida/model-aumento-con-una-perdida1.h5")
        elif i == 2:
            (train_x, train_y), (valid_x, valid_y), (test_x, test_y) = load_data2(dataset_path)
            save_path = "experimentos/resultados/experimento2/caso2/"
            cvc_path = "experimentos/resultados/experimento2/caso2/score.csv"
            """ Load Model """
            with CustomObjectScope({'iou': iou, 'dice_coef': dice_coef}):
                model = tf.keras.models.load_model("/home/DIINF/labello/U-net-original/files-con-una-perdida/model-aumento-con-una-perdida2.h5")
        elif i == 3:
            (train_x, train_y), (valid_x, valid_y), (test_x, test_y) = load_data3(dataset_path)
            save_path = "experimentos/resultados/experimento3/caso2/"
            cvc_path = "experimentos/resultados/experimento3/caso2/score.csv"
            """ Load Model """
            with CustomObjectScope({'iou': iou, 'dice_coef': dice_coef}):
                model = tf.keras.models.load_model("/home/DIINF/labello/U-net-original/files-con-una-perdida/model-aumento-con-una-perdida3.h5")
        elif i == 4:
