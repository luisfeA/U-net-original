...
def load_data(path, split=0.3):
    ...
    for imagen in os.listdir("/home/DIINF/labello/U-net-original/" + path + "images-aumentadas/"):
        ...
        train_x = train_x - sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen12.jpg")))
        train_x = train_x - sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen19.jpg")))
        train_x = train_x - sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen20.jpg")))
        train_x = train_x - sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen2.jpg")))
        train_x = train_x - sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen6.jpg")))
        train_x = train_x - sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen10.jpg")))
    print(train_x)
