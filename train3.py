...
def load_data(path, split=0.3):
    ...
    train_x = train_x.remove(sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen12.jpg")))[0])
    train_x = train_x.remove(sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen19.jpg")))[0])
    train_x = train_x.remove(sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen20.jpg")))[0])
    train_x = train_x.remove(sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen2.jpg")))[0])
    train_x = train_x.remove(sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen6.jpg")))[0])
    train_x = train_x.remove(sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen10.jpg")))[0])
    print(train_x)
...
def load_data4(path, split=0.3):
    ...
    valid_x = sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen10.jpg")))
    ...
    valid_y = sorted(glob(os.path.join(path + "mask-original/", "Placa1-imagen10.jpg")))
    ...
    test_x = sorted(glob(os.path.join(path + "images-original/", "Placa1-imagen10.jpg")))
    ...
    test_y = sorted(glob(os.path.join(path + "mask-original/", "Placa1-imagen10.jpg")))
